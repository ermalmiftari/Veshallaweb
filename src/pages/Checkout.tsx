// src/pages/Checkout.tsx (or wherever your routes live)
...
export default function Checkout(): JSX.Element {
  ...
  const handlePay = async () => {
    ...
    try {
      ...
      // Clear cart locally; DB will be finalized by Stripe webhook
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full rounded-lg bg-stone-900 border border-stone-700 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-amber-500/70"
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full rounded-lg bg-stone-900 border border-stone-700 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-amber-500/70 min-h-[80px]"
            ...
            <button
              ...
              onClick={handlePay}
              className={`w-full mt-2 py-3 rounded-lg font-semibold text-sm sm:text-base ${
        ...
        <section className="bg-stone-900/60 border border-stone-800 rounded-2xl p-5 sm:p-7 shadow-xl">
          ...
          {items.length === 0 ? (
            <p className="text-gray-400 text-sm">
              Your cart is empty. <a href="/shop" className="text-amber-300 underline">Go back to shop</a>.
            </p>
          ) : (
            <>
              ...
              <div className="border-t border-stone-700 mt-4 pt-4 space-y-2 text-sm">
                <div className="flex justify-between text-gray-300">
                  <span>Subtotal</span>
                  <span>{subtotal.toFixed(2)} €</span>
                </div>
                {/* In future: shipping, tax, etc. */}
