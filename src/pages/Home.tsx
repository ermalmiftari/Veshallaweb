      ...
      >
        ...
        <div className="relative z-10 max-w-3xl">
          ...
          <div className="flex flex-wrap justify-center gap-4 max-w-3xl mx-auto">
            ...
            >
              <div className="text-3xl mb-1">🔴</div>
              <div className="font-bold text-lg mb-1 flex items-center justify-center gap-2">Live Camera</div>
        ...
        <div className="max-w-5xl mx-auto px-6 relative z-10">
          ...
          >
            <div className="inline-block mb-4">
              <div className="flex items-center gap-2 bg-gradient-to-r from-emerald-600 to-emerald-700 text-white px-4 py-2 rounded-full shadow-lg">
                ...
                <span className="font-semibold text-sm">Discover Our Story</span>
              </div>
            </div>
          ...
          <div className="space-y-6">
            ...
            >
              <p className="text-slate-800 text-lg leading-relaxed">
                Veshalla is one of the highest villages in the Šar Mountains, perched at an elevation where clouds drift
                through the valleys below. Surrounded by pristine forests, crystal-clear mountain streams, and some of
                the cleanest air in the region, this village represents a connection to nature that is increasingly rare
                in our modern world.
              </p>
            </motion.div>
            ...
            >
              <p className="text-slate-800 text-lg leading-relaxed">
                For centuries, Veshalla has been home to resilient communities who have built their lives around the
                rhythm of the mountains. Today, while many families have spread across Switzerland, Germany, Italy, and
                the USA in search of opportunities, the heart of every Veshalla family still beats in these highlands.
                Every summer, the village comes alive as diaspora members return to reconnect with their roots, preserve
                traditions, and share stories under the mountain sky.
              </p>
            </motion.div>
            ...
            >
              <p className="text-slate-800 text-lg leading-relaxed">
                The village is not just a place—it's a living heritage of mountain culture, traditional architecture,
                and a community bond that transcends borders. Whether you're seeking adventure, tranquility, or a
                glimpse into authentic mountain life, Veshalla welcomes you with open arms and the warmth of highland
                hospitality.
              </p>
            </motion.div>
          </div>
          ...
          >
            ...
            <div className="bg-gradient-to-br from-orange-500 to-orange-600 rounded-xl p-4 text-center text-white shadow-lg">
              <div className="text-3xl font-bold">Centuries</div>
              <div className="text-sm text-orange-100">Of Heritage</div>
            </div>
            <div className="bg-gradient-to-br from-amber-500 to-amber-600 rounded-xl p-4 text-center text-white shadow-lg">
              ...
              <div className="text-sm text-amber-100">Clear Air</div>
            </div>
            ...
            >
              <div className="inline-block mb-3">
                <div className="flex items-center gap-2 bg-gradient-to-r from-emerald-600 to-teal-600 text-white px-4 py-2 rounded-full shadow-lg">
                  <span className="text-xl">📸</span>
                  <span className="font-semibold text-sm">Visual Journey</span>
                </div>
              </div>
              ...
              <p className="text-slate-700 text-lg mt-3">Explore beautiful moments from Veshalla</p>
            </motion.div>
            <motion.button
              initial={{ opacity: 0, scale: 0.9 }}
              whileInView={{ opacity: 1, scale: 1 }}
              ...
              {gallery.map((src, i) => (
                ...
                >
                  ...
                  <div className="absolute bottom-3 left-3 right-3 text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <div className="text-sm font-semibold">Veshalla Moments</div>
                  </div>
                </motion.div>
              ))}
            </div>
      ...
      <AnimatePresence>
        {menuOpen && (
          ...
          >
            ...
            <button
              onClick={() => {
                document.getElementById("hiking")?.scrollIntoView()
                setMenuOpen(false)
              }}
              className="hover:text-amber-300"
            >
